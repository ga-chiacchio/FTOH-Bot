...
const LAS_VEGASPUBLIC_INFO: CircuitInfo = {
  ...
  checkpoints: [],
  lastPlace: {
    x: las_vegasPublic_json.redSpawnPoints[
      las_vegasPublic_json.redSpawnPoints.length - 1
    ][0],
    y: las_vegasPublic_json.redSpawnPoints[
      las_vegasPublic_json.redSpawnPoints.length - 1
    ][1],
  },
  BestTime: bestTimes.las_vegasPublic,
