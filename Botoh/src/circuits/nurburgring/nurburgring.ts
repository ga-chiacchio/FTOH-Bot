...
const nurburgring_raw = readFileSync(
  join(__dirname, "nurburgring.hbs"),
  "utf-8"
);
...
const NURBURGRING_INFO: CircuitInfo = {
  ...
  checkpoints: [],
  lastPlace: {
    x: nurburgring_json.redSpawnPoints[
      nurburgring_json.redSpawnPoints.length - 1
    ][0],
    y: nurburgring_json.redSpawnPoints[
      nurburgring_json.redSpawnPoints.length - 1
    ][1],
  },
