...
export const CIRCUITS: Circuit[] = LEAGUE_MODE?[
    SUZUKA, MELBOURNE, BAKU, SPA, IMOLA, NURBURGRING, SHANGHAI, AUSTIN, MONZA, CANADA, SEPANG, BAHRAIN, VALENCIA, SILVERSTONE, MONACO, SOCHI, PAUL_RICARD, ISTANBUL, INTERLAGOS, ARGENTINA, MARINA_BAY, JEDDAH, ABU_DHABI, HOCKEN, FUJI, HUNGARY, AUSTRIA, LAGUNA_SECA, BALATON, MEXICO, NURBURGRINGNANO, HUNGARYNANO, SPALEAGUE, INDIANAPOLIS]
    :[
        //REMEMBER TO ADD SILVERSTONE
    SUZUKA, MELBOURNE, BAKU, SPA, IMOLA, NURBURGRING, SHANGHAI, AUSTIN, MONZA, CANADA, SEPANG, BAHRAIN, VALENCIA, MONACO, SOCHI, PAUL_RICARD, ISTANBUL, INTERLAGOS, ARGENTINA, MARINA_BAY, JEDDAH, ABU_DHABI, HOCKEN, FUJI, HUNGARY, AUSTRIA, LAGUNA_SECA, MEXICO]
