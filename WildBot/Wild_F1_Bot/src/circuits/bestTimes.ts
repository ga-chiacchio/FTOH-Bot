...
export const bestTimes: { [key: string]: [number, string, string] } = {
  melbourne: [28.100, "Ximbastian Vettel", trackNameMapping["melbourne"]],
  ...
  austin: [50.783, "Lando Canorris", trackNameMapping["austin"]],
  shanghai: [41.217, "Ximbastian Vettel", trackNameMapping["shanghai"]],
  suzuka: [33.967, "Ximbastian Vettel", trackNameMapping["suzuka"]],
  interlagos: [33.800, "Gabriel Schumacchio", trackNameMapping["interlagos"]],
  baku: [47.983, "Schumacchio", trackNameMapping["baku"]],
  ...
  jeddah: [43.633, "Ximbastian Vettel", trackNameMapping["jeddah"]],
  yasMarina: [39.800, "Ximbastian Vettel", trackNameMapping["yasMarina"]],
